...
export function OverviewSection({ stats, filteredSales, salesByDay, revenueByCategory, topProducts, lowStock, outOfStock, pendingDebtsCount }: OverviewSectionProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <KPICard label="Pending Debts" value={`KES ${formatKES(stats?.debtsPending || 0)}`} sub={`${pendingDebtsCount} accounts`} accent="#ef4444" icon="💳" />
