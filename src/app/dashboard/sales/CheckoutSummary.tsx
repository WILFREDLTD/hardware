      ...
      <div className="mt-3 grid grid-cols-2 gap-2">
        <div className="rounded-2xl border border-gray-100 bg-white p-3">
          <div className="flex items-center gap-2 mb-2">
            ...
            <div className="min-w-0">
              <div className="text-[10px] font-medium uppercase tracking-[0.14em] text-slate-900 leading-tight">Supplier Name</div>
            </div>
          </div>
          <input
            type="text"
            value={supplierName}
            onChange={(e) => setSupplierName(e.target.value || 'unknown')}
            placeholder="unknown"
            className="w-full rounded-xl border border-gray-200 bg-slate-50 px-3 py-2 text-sm font-semibold text-slate-800 focus:border-emerald-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-100"
          />
        </div>
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-3">
          <div className="flex items-center gap-2 mb-2">
            ...
            <div className="min-w-0">
              <div className="text-[10px] font-medium uppercase tracking-[0.14em] text-slate-900 leading-tight">Supplier Number</div>
            </div>
          </div>
          <input
            type="text"
            value={supplierNumber}
            onChange={(e) => setSupplierNumber(e.target.value || 'unknown')}
            placeholder="unknown"
            className="w-full rounded-xl border border-gray-200 bg-slate-50 px-3 py-2 text-sm font-semibold text-slate-800 focus:border-emerald-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-100"
          />
        </div>
